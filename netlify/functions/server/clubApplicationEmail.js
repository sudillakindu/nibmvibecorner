...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const templatePathConfirmationHtml = path.join(process.cwd(), 'netlify/functions/emailTemplate/clubApplicationConfirmation.html');
    ...
    const templatePathNotificationHtml = path.join(process.cwd(), 'netlify/functions/emailTemplate/clubApplicationNotification.html');
