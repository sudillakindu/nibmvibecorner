...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const templatePathConfirmationHtml = path.join(process.cwd(), 'netlify/functions/emailTemplate/signupApplicationConfirmation.html');
    ...
    const templatePathNotificationHtml = path.join(process.cwd(), 'netlify/functions/emailTemplate/signupApplicationNotification.html');
